...
abstract class ErrorTemplate
{
	 ...
	 */
	public function __construct($data = null, array $context = [], $message = null, $fullTrace = false)
	{
		$this->data = $data;
	 ...
	 */
	public function printErrorMessage($contentType, $statusCode)
	{
		switch ($contentType) {
			case ContentType::TEXT:
				return $this->getContents($this->getText(), $statusCode);
				break;
			case ContentType::HTML:
				return $this->getContents($this->getHTML(), $statusCode);
				break;
			case ContentType::XML:
				return $this->getContents($this->getXML(), $statusCode);
				break;
			case ContentType::JSON:
				return $this->getContents($this->getJSON(), $statusCode);
				break;
		}
	}
	 ...
	 * @return String       String buffer containing a template
	 */
	protected function getContents($file, $statusCode)
	{
		ob_start();
